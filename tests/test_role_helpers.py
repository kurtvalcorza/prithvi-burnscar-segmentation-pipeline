...
import prithvi_burnscar_segmentation_pipeline as pkg
from conftest import synthetic_records
from prithvi_burnscar_segmentation_pipeline import BANDS, IGNORE_INDEX, IMAGE_SIZE, INPUT_SCHEMA, validate_inputs
...
def test_public_surface_is_exported():
    ...
    assert "PrithviBurnScarPipeline" in pkg.__all__ and "audit_pickle" in pkg.__all__
