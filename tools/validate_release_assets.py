"""Static release-asset validation for the Prithvi-EO-2.0 burn-scar-segmentation DIMER pipeline.
...
REPO_NAME = "prithvi-burnscar-segmentation-pipeline"
NOTEBOOK_NAME = "prithvi_burnscar_segmentation_colab.ipynb"
EXPECTED_PROFILE = "E2E"
EXPECTED_MODEL_ID = "ibm-nasa-geospatial/Prithvi-EO-2.0-300M-BurnScars"
...
# The HLS Burn Scars dataset revision is cited beside the model pin.
KNOWN_SHAS: frozenset[str] = frozenset({"1864285e25010d346a842e4f068b1a1d4248ed6d"})
BYOD_GATES = ("USE_BYOD",)
EXPECTED_OUTPUTS = (
    "outputs/prithvi_burnscar_segmentation_sample_chip.tif",
    "outputs/prithvi_burnscar_segmentation_sample_label.tif",
    "outputs/prithvi_burnscar_segmentation_sample_pairs.csv",
    "outputs/prithvi_burnscar_segmentation_evaluation_report.json",
    "outputs/prithvi_burnscar_segmentation_predictions.json",
    "outputs/prithvi_burnscar_segmentation_adapter",
    "outputs/prithvi_burnscar_segmentation_result.json",
)
CODE_MARKERS = (
    # Stage 3 (fixed cell): the pickle audit and the conversion are printed before the model loads
    "report=print)",
    # Stage 4: pinned tarball members, roles, sample pair, refusal probes
    "USE_BYOD = False",
    ...
    "write_sample_pair(test_records[0], 'outputs/prithvi_burnscar_segmentation_sample_chip.tif', 'outputs/prithvi_burnscar_segmentation_sample_label.tif')",
    "validate_dataset(records)",
    # Stage 5: frozen model against the not-burned baseline
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    525_272: "each hls_burn_scars .mask.tif member in the dataset tarball",
    81_276_896: "Prithvi burn-scar fine-tune adapter.safetensors from the tutorial run (34 tensors)",
    300_099_360: "88 pinned hls_burn_scars tar members (44 scenes + 44 masks), total",
    1_297_682_024: "prithvi-eo-2.0-300m-burnscars.safetensors converted from the .pt (git-ignored)",
    2_645_552_531: "hls_burn_scars.tar.gz, dataset ibm-nasa-geospatial/hls_burn_scars at 1864285",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "4209c5a013f90dfe372abb4ade3865e7a283d655ef17b1c7de95d36ecc033c3f": "prithvi-eo-2.0-300m-burnscars.safetensors converted from the .pt",
    "4e6f99a75cb2c500547b20662a15cbd531dc421376f815e91846ea542798e8e6": "hls_burn_scars.tar.gz, dataset ibm-nasa-geospatial/hls_burn_scars at 1864285",
    "5b9f0ba08490293d6c17b9cef219991e1a6edda31609429679f8dca1af5a7b10": "pickle-audit digest of the Prithvi_EO_V2_300M_BurnScars.pt global set",
}
